...
// unaryExp: primaryExp | T_ID T_L_PAREN T_R_PAREN | T_ID T_L_PAREN realParamList T_R_PAREN | T_SUB unaryExp
UnaryExp : PrimaryExp {
		// 基本表达式
	...
	| T_SUB UnaryExp {
        ...
        $$ = create_contain_node(ast_operator_type::AST_OP_MINUS, $2);
    }
	;
